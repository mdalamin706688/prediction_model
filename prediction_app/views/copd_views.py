...
from ..models.copd_models import COPDData
from ..models.copd_models import load_model_from_file

class COPDPredictionView(APIView):
    ...
    def post(self, request):
        try:
            ...
            # Load the pre-trained model for COPD
            model = load_model_from_file('pkl/copd_model.pkl')
